...
function reporte(){
	...
	window.open("https://ebh2y8tqym512wqs.cbetxkdyhwsb.us-east-1.rds.amazonaws.com/report/ventas/download?fecha_inicio="+fecha1+"&fecha_fin="+fecha2+"&tipo="+tip0);
...
function reporte2(){
	...
	window.open("ebh2y8tqym512wqs.cbetxkdyhwsb.us-east-1.rds.amazonaws.com/Ventas/ventas/download?fechaInicio="+fecha3+"&fechaFin="+fecha4+"&tipo="+tipo1);
...
function reporte3(){
	...
	window.open("ebh2y8tqym512wqs.cbetxkdyhwsb.us-east-1.rds.amazonaws.com/reporteTotales/ventas/download?fechaInicio="+fecha5+"&fechaFin="+fecha6+"&tipo="+tipo2);
...
function reporte4(){
	...
	window.open("ebh2y8tqym512wqs.cbetxkdyhwsb.us-east-1.rds.amazonaws.com/Vendedor/ventas/download?fechaInicio="+fecha7+"&fechaFin="+fecha8+"&tipo="+tipo3);
