...
public class ReporteVentas2Controller {

	@Autowired
	private ReporteVentas2ServiceAPI reporteVentas2ServiceAPI;

	@GetMapping(path = "/ventas/download")
	public ResponseEntity<Resource> download(@RequestParam Map<String, Object> params)
			throws JRException, IOException, SQLException {
		ReporteVentasDTO dto = reporteVentas2ServiceAPI.obtenerReporteVentas(params);
